...
<template>
  <div class="container pt-10 max-xl:px-6">
    ...
    <p class="mt-8 w-2/3 max-sm:w-full max-sm:mt-4">
    ...
    <div class="grid grid-cols-2 mt-12 gap-24 max-lg:gap-12 max-sm:grid-cols-1 max-sm:mt-6 max-md:gap-8">
      <div>
        <div class="space-y-10 max-lg:space-y-6">
          <p class="text-2xl font-bold">{{ $t('blog.today.shareYourMoment') }}</p>
          <div class="flex justify-start gap-9 items-center max-md:gap-6">
          ...
          <div class="flex justify-between gap-8 max-lg:gap-6">
            <p
        ...
        <UCarousel
          ...
          class="w-full mt-12 max-sm:mt-10"
        >
          <img :src="item" class="object-cover max-sm:h-40 max-sm:w-70" />
        </UCarousel>
      </div>
      <img src="/images/people2.png" alt="" class="h-160 max-sm:h-100 object-cover max-lg:h-130 max-md:h-120 max-sm:hidden" />
    </div>
  </div>
</template>
