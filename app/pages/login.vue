...
import { loginSchema, type IFormLogin } from '~/schemas/login.schema'
  ...
  <div>
    <div class="grid grid-cols-[2fr_1fr] max-md:grid-cols-1">
      <div class="mx-[135px] my-20 max-lg:mx-20">
        <p class="title">NGS</p>
        <p class="text-xl font-bold my-10">Đăng nhập vào NexGen Speak</p>
        ...
        <div class="mt-4 flex justify-between items-center max-xl:flex-col max-xl:gap-4">
          <p class="font-bold text-sm">
            ...
            <span class="text-primary hover:cursor-pointer hover:underline">Mật Khẩu?</span>
          </p>
      ...
      <img src="/images/banner-auth.png" alt="" class="object-cover h-full max-md:hidden" />
    </div>
    <UiAuthSupport />
  </div>
</template>
