...
<template>
  <div>
    ...
    <Transition name="fade-scale" appear>
      <div v-if="!isFetchingTeacherDetail" key="content" class="container py-10 max-xl:px-6">
        <div class="grid grid-cols-[2fr_1fr] gap-10 max-[900px]:grid-cols-1" :class="{ 'grid-cols-1! w-full': !isAuthenticated }">
